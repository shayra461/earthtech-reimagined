    ...
    <footer className="section-dark">
      <div className="container-full mx-auto px-6 md:px-10 pt-20 pb-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
          ...
          <div>
            <h4 className="text-xs font-semibold tracking-[0.2em] uppercase mb-6" style={{ color: "hsl(var(--section-dark-foreground) / 0.4)" }}>Location</h4>
            <p className="text-sm leading-relaxed mb-6" style={{ color: "hsl(var(--section-dark-foreground) / 0.65)" }}>
              5949 E. University Dr.<br />
              Mesa, AZ 85205
            </p>
            <h4 className="text-xs font-semibold tracking-[0.2em] uppercase mb-4 mt-8" style={{ color: "hsl(var(--section-dark-foreground) / 0.4)" }}>Contact</h4>
            <div className="flex flex-col gap-2">
              <a href="mailto:mlanfrankie@healingearthtech.com" className="text-sm transition-colors hover:opacity-100" style={{ color: "hsl(var(--section-dark-foreground) / 0.65)" }}>
                mlanfrankie@healingearthtech.com
              </a>
              <a href="tel:+16026160014" className="text-sm transition-colors hover:opacity-100" style={{ color: "hsl(var(--section-dark-foreground) / 0.65)" }}>
                +1 (602) 616-0014
              </a>
            </div>
          </div>
